...
HD_PWD='C:/Users/namso/Desktop/school/ecen 248/lab_11/lab_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_controller_ver1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlc_controller_ver1.tcl -notrace
